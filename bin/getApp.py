    ...
    def extractFromZip(filename, zip):
        ...
        if zip.getinfo(filename).file_size > 0:
            ...
            if args.suffixApp is not None or args.newApp is not None:
                ...
                try:
                    os.replace(args.dir + f'/{filename}', args.dir + f'/{newfilename}')
                except Exception as e:
                    print("ERROR Renaming directory "+str(e))
        else:
