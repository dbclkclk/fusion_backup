    ...
    def putSchema(colName):
        ...
        for file in files:
            ...
            if os.path.isfile(file):
                ...
                sub1 = args.dir+f"/configsets/{colName}/"
                sub2 = "./"+file
                dep = (sub2).partition(sub1)[2];
                url = schemaUrl + "/" + dep
                ...
                try:
                    response = doHttpPostPut(url, file, (dep in currentZkFiles))
                    response.raise_for_status()
                    if args.verbose:
